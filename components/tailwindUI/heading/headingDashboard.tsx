...
import { classNames, getQuery } from '../../../src/utils/function'
import { useRouter } from 'next/router'
import { Food, Page, Product, Site } from '../../../interfaces'
// import { TabFormFood, TabFormPage, TabFormProduct, TabFormSite } from '../../headles'
import { typePageEcommerceCategory, typePageFoodCategory, typeSite } from '../../../src/utils'

import { CubeIcon, FolderPlusIcon, TrashIcon } from '@heroicons/react/24/outline'
import Link from 'next/link'
import { useDeleteManyProductById } from '../../../src/hooks'
  ...
  return (
    <div className="flex lg:items-center lg:justify-between pt-6 pb-1 sm:pt-10">
      <div className="min-w-0 flex-1">
        <div className='flex'>
          <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight mr-3">{title}</h2>
          {
            site &&
